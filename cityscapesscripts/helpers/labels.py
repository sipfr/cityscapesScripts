...
labels = [
    ...
    Label(  'person'               , 24 ,        6 , 'human'           , 6       , False        , False        , (220, 20, 60) ),
    Label(  'rider'                , 25 ,        6 , 'human'           , 6       , False        , False        , (255,  0,  0) ),
    Label(  'car'                  , 26 ,        7 , 'vehicle'         , 7       , False        , False        , (  0,  0,142) ),
    Label(  'truck'                , 27 ,        7 , 'vehicle'         , 7       , False        , False        , (  0,  0, 70) ),
    Label(  'bus'                  , 28 ,        7 , 'vehicle'         , 7       , False        , False        , (  0, 60,100) ),
    Label(  'caravan'              , 29 ,        7 , 'vehicle'         , 7       , False        , True         , (  0,  0, 90) ),
    Label(  'trailer'              , 30 ,        7 , 'vehicle'         , 7       , False        , True         , (  0,  0,110) ),
    Label(  'train'                , 31 ,        7 , 'vehicle'         , 7       , False        , False        , (  0, 80,100) ),
    Label(  'motorcycle'           , 32 ,        7 , 'vehicle'         , 7       , False        , False        , (  0,  0,230) ),
    Label(  'bicycle'              , 33 ,        7 , 'vehicle'         , 7       , False        , False        , (119, 11, 32) ),
    Label(  'license plate'        , 34 ,        7 , 'vehicle'         , 7       , False        , True         , (  0,  0,142) ),
]
